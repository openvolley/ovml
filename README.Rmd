...
[![R build status](https://github.com/openvolley/ovml/workflows/R-CMD-check/badge.svg)](https://github.com/openvolley/ovml/actions)
<!-- badges: end -->
...
Currently three versions of the [YOLO](https://pjreddie.com/darknet/yolo/) object detection algorithm are included (versions 3, 4, and 7). These have been implemented on top of the [torch](https://torch.mlverse.org/) R package, meaning that no Python installation is required on your system.
